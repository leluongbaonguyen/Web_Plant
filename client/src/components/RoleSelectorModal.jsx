  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/80 p-4 backdrop-blur-md animate-fadeIn">
      <div className="glass-panel w-full max-w-2xl rounded-3xl border border-slate-700 bg-slate-900/95 p-6 shadow-2xl space-y-6 max-h-[90vh] overflow-y-auto custom-scrollbar">
        ...
        <div className="rounded-2xl border border-slate-800 bg-slate-950 p-4 text-xs text-slate-400 space-y-1">
          <div className="font-bold text-slate-200 flex items-center gap-1.5">
            <Lock className="h-4 w-4 text-emerald-400" /> Hệ Thống Đã Bật Bảo Mật Phân Quyền Bắt Buộc
          </div>
          <p>
            Tất cả quyền quản trị (Admin) và biên tập (Editor) đều yêu cầu đăng nhập mật khẩu chính xác. Không thể tự do chuyển đổi nhanh để đảm bảo an toàn dữ liệu.
          </p>
        </div>
