...
import { Activity, Award, CheckCircle2, Clock, ShieldCheck, Sparkles, Target, Zap, ArrowRight } from 'lucide-react';
    ...
    <div className="space-y-6 animate-fadeIn">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-center">
          <div className="md:col-span-8 space-y-4">
            <div className="inline-flex items-center gap-2 rounded-full border border-indigo-500/40 bg-indigo-500/10 px-3.5 py-1 text-xs font-bold text-indigo-300">
              ...
              <span>ChronoFlow v2.0</span>
            </div>

            <h2 className="text-2xl md:text-4xl font-extrabold font-heading text-white tracking-tight leading-tight">
              Quản lý Lịch Sinh Hoạt & <span className="gradient-text-indigo font-black">Tiến Độ Thông Minh</span>
            </h2>

            <p className="text-xs md:text-sm text-slate-300 max-w-xl leading-relaxed">
              Hệ thống lập kế hoạch và theo dõi lịch sinh hoạt 7 ngày trong tuần. Tự động nhắc nhở, biên tập mục tiêu và theo dõi hiệu suất làm việc.
            </p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="glass-card glass-card-interactive rounded-2xl p-5 border border-indigo-500/30 space-y-3">
          ...
          <p className="text-[11px] text-slate-400 font-medium">{completedCells} / {totalCells} ô sinh hoạt đã hoàn thành</p>
        </div>
        ...
        <div className="glass-card glass-card-interactive rounded-2xl p-5 border border-amber-500/30 space-y-3">
          ...
          <p className="text-[11px] text-slate-400 font-medium">Tổng kết hiệu suất tuần</p>
        </div>
        ...
        <div className="glass-card glass-card-interactive rounded-2xl p-5 border border-purple-500/30 space-y-3">
          ...
          <p className="text-[11px] text-slate-400 leading-tight">
            {permissions.canManageSlots ? 'Toàn quyền Quản trị (Admin)' : 'Quyền theo dõi & cập nhật'}
          </p>
        </div>
      </div>
    </div>
