...
const COURSE_LEVELS = [
  {
    ...
    "description": "Từ đơn, câu 2–4 từ. Màu sắc, số đếm 1-10, hình dạng, gia đình, cơ thể, động vật, đồ ăn, lớp học, động từ, cảm xúc, đồ chơi, côn trùng, phòng tắm, nông trại & trái nghĩa.",
    "icon": "🐥",
    "targetWords": 150
  },
  {
    ...
    "description": "Câu 3–6 từ. Ngôi nhà, quần áo, sinh hoạt hằng ngày, thời tiết, giao thông, địa điểm, nghề nghiệp, trái cây/rau củ, thời gian, thể thao, môn học, nhà bếp, động vật biển, mùa & vị trí.",
    "icon": "🦁",
    "targetWords": 150
  },
  {
    ...
    "description": "Giao tiếp thực tế. Thiên nhiên, sức khỏe, mua sắm, du lịch, công nghệ, sở thích, cộng đồng, lễ hội, tính cách, bảo vệ Trái Đất, nhà hàng, văn phòng, thiên tai, truyền thông & miêu tả con người.",
    "icon": "🚀",
    "targetWords": 150
  },
  {
    ...
    "description": "Từ học thuật, khoa học, tư duy & công dân. Khoa học cơ bản, không gian, từ học thuật, giao tiếp, giải quyết vấn đề, cảm xúc nâng cao, quốc gia/văn hóa, an toàn số, kể chuyện, mục tiêu, toán học, cơ thể bên trong, hóa học, nghệ thuật & xã hội.",
    "icon": "👑",
    "targetWords": 150
  }
];
...
console.log('Categories count:', VOCAB_CATEGORIES.length);
