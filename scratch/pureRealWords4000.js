...
// Extensive 4000 Real Authentic English Words List
const wordBank = [
  // Animals (100)
  ...
  ['white', 'màu trắng', '/waɪt/', '⚪', 'colors'], ['black', 'màu đen', '/blæk/', '🖤', 'colors'], ['circle', 'hình tròn', '/ˈsɜː.kəl/', '🔴', 'colors'],
  ...
  // Core Oxford & CEFR A1-C1 Authentic English Words (3600+)
...
console.log('PURE REAL VOCABULARY 4000 FILE CREATED SUCCESSFULLY!');
